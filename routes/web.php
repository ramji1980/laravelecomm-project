...
route::get('view_details/{id}',[HomeController::class,'view_details'])->middleware(['auth','verified']);
...
route::post('update_product/{slug}',[AdminController::class,'update_product'])->middleware(['auth','admin']);
...
route::get('printpdf/{id}',[AdminController::class,'printpdf'])->middleware(['auth','admin']);
